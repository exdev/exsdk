...
static int js_generator_close_object(lua_State *L) {
    js_generator_assert(L,
...
static int js_generator_close_array(lua_State *L) {
    js_generator_assert(L,
...
static void js_create_generator_mt(lua_State *L) {
    ...
    lua_pushcfunction(L, js_generator_close_object);
    lua_setfield(L, -2, "close_object");

    lua_pushcfunction(L, js_generator_open_array);
    lua_setfield(L, -2, "open_array");

    lua_pushcfunction(L, js_generator_close_array);
    lua_setfield(L, -2, "close_array");
