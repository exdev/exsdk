...
// File         : compiler.h
// Author       : Wu Jie 
// Last Change  : 06/26/2010 | 08:25:30 AM | Saturday,June
// Description  : 
// ======================================================================================

// #################################################################################
#ifndef COMPILER_H_1277511938
#define COMPILER_H_1277511938
// #################################################################################
...
// ------------------------------------------------------------------ 
        ...
        #undef EX_CDECL
    #endif
    #define EX_CDECL cdecl
#elif ( EX_COMPILER == EX_GCC )
    #ifdef EX_CDECL
        #undef EX_CDECL
    #endif
    #define EX_CDECL __attribute__ ((cdecl)) 
#endif
...
// #################################################################################
#endif // END COMPILER_H_1277511938
// #################################################################################
